...
execute as @a[dx=56,dy=40,dz=47,tag=cr_red] at @s run playsound mob.villager.yes @s
execute as @a[dx=56,dy=40,dz=47,tag=cr_blue] at @s run playsound mob.villager.no @s
